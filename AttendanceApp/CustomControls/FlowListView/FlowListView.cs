...
#pragma warning restore 0219
        ...
        protected override void OnPropertyChanged(string propertyName = null)
        {
            ...
            if (propertyName == FlowColumnIsRefreshingProperty.PropertyName)
            {
                FlowColumnIsRefreshing = true;
            }
        }
        public bool? FlowColumnIsRefreshing
        {
            get { return (bool?)GetValue(FlowColumnIsRefreshingProperty); }
            set { SetValue(FlowColumnIsRefreshingProperty, value); }
        }

        public static readonly BindableProperty FlowColumnIsRefreshingProperty = BindableProperty.Create(nameof(FlowColumnIsRefreshing), typeof(bool), typeof(FlowListView), true, Xamarin.Forms.BindingMode.TwoWay);
        /// <summary>
